export default function CategoryCard({ icons, text }) {
    return (
        <div className="w-full bg-white rounded-lg shadow-md overflow-hidden border border-gray-100 hover:cursor-pointer transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg">

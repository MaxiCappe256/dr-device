  ...
  return (
    <div className="relative">
      <Button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className={`group rounded-lg border border-primary/20 p-2.5 shadow-sm shadow-primary/10 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/20 ${
      ...
      <div
        className={`absolute right-0 top-14 z-50 w-72 overflow-hidden rounded-xl border border-surface-container-highest bg-surface-container-lowest text-on-surface shadow-2xl shadow-primary/10 transition-all duration-200 ${
          open
      ...
      >
        <div className="auth-brand-panel p-4 text-on-primary">
          <div className="flex items-center gap-3">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-on-primary/15">
              <UserIcon height={24} />
            </div>
            ...
            {links.map((link) => (
              <li key={link.to}>
                <NavLink
                  ...
                  className="block rounded-lg px-4 py-3 text-base font-medium text-on-surface-variant transition-colors hover:bg-surface-container-low hover:text-primary"
                >
                  {link.label}
                </NavLink>
              </li>
        ...
        <div className="p-2">
          <Button
            ...
            type="button"
            className="justify-start rounded-md px-4 py-3 text-left text-base font-medium  transition-colors"
            onClick={() => onLogout()}
